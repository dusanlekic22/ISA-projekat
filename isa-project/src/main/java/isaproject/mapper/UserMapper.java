...
public class UserMapper {
	...
	public static FishingTrainerDTO FishingTrainerToDTO(FishingTrainer fishingTrainer) {
		...
		fishingTrainerDTO.setLoyaltyProgram(fishingTrainer.getLoyaltyProgram());
		fishingTrainerDTO.setGrades(fishingTrainer.getGrades());
	...
	public static CottageOwnerDTO CottageOwnerToDTO(CottageOwner cottageOwner) {
		...
		cottageOwnerDTO.setGrades(cottageOwner.getGrades());
	...
	public static BoatOwnerDTO BoatOwnerToDTO(BoatOwner boatOwner) {
		...
		boatOwnerDTO.setGrades(boatOwner.getGrades());
		return boatOwnerDTO;
	}
