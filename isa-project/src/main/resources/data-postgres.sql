...
insert into cottage (name, promo_description, average_grade, bed_count, room_count, price_per_hour, cottage_rules,address_id,cottage_owner_id, deleted) values ('Vila Jezero', 'Najjaca', 2.7, 3, 15,3,'Nema',5,4,false);
...
insert into grade (value, review, is_accepted, cottage_id) values (2.7,'Solidna usluga',1,4);
...
insert into cottage_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, cottage_id,customer_id) values ('2022-06-15T13:22:11', '2022-06-18', 5, 70, 50, 100, true, false, 4,6);
insert into cottage_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, cottage_id,customer_id) values ('2022-06-04T12:22:11', '2022-06-12', 5, 70, 50, 100, true, false, 4,6);
insert into cottage_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, cottage_id,customer_id) values ('2022-05-25', '2022-06-03', 5, 70, 50, 100, true,false, 4,5);
insert into cottage_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, cottage_id,customer_id) values ('2022-05-11', '2022-05-13', 6, 100, 50, 100, true,false, 4,5);
insert into cottage_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, cottage_id,customer_id) values ('2021-05-11', '2021-05-13', 6, 100, 50, 100, true,false, 4,5);
insert into cottage_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled,  cottage_id,customer_id) values ('2020-05-11', '2020-05-13', 6, 100, 50, 100, true,false, 4,5);
insert into cottage_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, cottage_id,customer_id) values ('2023-05-11', '2023-05-13', 6, 100, 50, 100, true,false, 4,5);
...
insert into boat_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, boat_id,customer_id) values ('2022-06-15T13:22:11', '2022-06-18', 5, 70, 50, 100, true, false, 4,6);
insert into boat_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, boat_id,customer_id) values ('2022-06-04', '2022-06-12', 5, 70, 50, 100, true, false, 4,6);
insert into boat_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, boat_id,customer_id) values ('2022-05-25', '2022-06-03', 5, 70, 50, 100, true, false, 4,5);
insert into boat_reservation (start_date, end_date, guest_capacity, price, owner_income, site_income, confirmed, is_cancelled, boat_id,customer_id) values ('2022-05-11', '2022-05-13', 6, 100, 50, 100, true, false, 4,5);
...
insert into fishing_reservation (start_date, end_date, capacity, price, owner_income, site_income, confirmed, is_cancelled, fishing_course_id, customer_id, location_id) values ('2022-06-15T13:22:11', '2022-06-18', 5, 70, 50, 100, true, false, 1,2,1);
insert into fishing_reservation (start_date, end_date, capacity, price, owner_income, site_income, confirmed, is_cancelled, fishing_course_id, customer_id, location_id) values ('2022-06-04T13:22:11', '2022-06-13', 5, 70, 50, 100, true, false, 1,2,1);
insert into fishing_reservation (start_date, end_date, capacity, price, owner_income, site_income, confirmed, is_cancelled, fishing_course_id, customer_id, location_id) values ('2022-05-25', '2022-05-30', 5, 70, 50, 100, true,false, 2,2,1);
insert into fishing_reservation (start_date, end_date, capacity, price, owner_income, site_income, confirmed, is_cancelled, fishing_course_id, customer_id, location_id) values ('2022-05-11', '2022-05-13', 6, 100, 50, 100, true,false, 1,2,2);
