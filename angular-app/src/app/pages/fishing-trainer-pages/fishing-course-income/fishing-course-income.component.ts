...
@Component({
  selector: 'app-fishing-course-income',
  templateUrl: './fishing-course-income.component.html',
  styleUrls: ['./fishing-course-income.component.css']
})
export class FishingCourseIncomeComponent implements OnInit {
  ...
  incomeChartYearly() {
    ...
    this._fishingCourseService
      .getFishingCourseIncomeYearlyById(this.fishingCourseId,this.duration)
      .subscribe((data) => {
  ...
  incomeChartMonthly() {
    ...
    this.incomeChart.config.type = 'pie' as ChartType;
    this._fishingCourseService
      .getFishingCourseIncomeMonthlyById(this.fishingCourseId,this.duration)
      .subscribe((data) => {
        let arr = [];
  ...
  incomeChartDaily() {
    ...
    this.incomeChart.config.type = 'pie' as ChartType;
    this._fishingCourseService
      .getFishingCourseIncomeDailyById(this.fishingCourseId,this.duration)
      .subscribe((data) => {
        let arr = [];
