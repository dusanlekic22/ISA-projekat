...
import isaproject.security.authority.RestAuthenticationEntryPoint;
import isaproject.security.authority.TokenAuthenticationFilter;
...
//								.antMatchers("/customer/**").permitAll()
								...
								.antMatchers("/boatReservation/confirm/**").permitAll()
								.antMatchers("/fishingReservation/confirm/**").permitAll()
								.antMatchers("/cottageQuickReservation/appoint/**").permitAll()
								.antMatchers("/boatQuickReservation/appoint/**").permitAll()
								.antMatchers("/fishingQuickReservation/appoint/**").permitAll()
								...
								.antMatchers("/fishingCourse/**").permitAll()
								.antMatchers("/cottage/availability").permitAll()
								.antMatchers("/cottage/pagination").permitAll()
								.antMatchers("/cottage/{id}").permitAll()
								.antMatchers("/boat/{id}").permitAll()
								.antMatchers("/fishingCourse/{id}").permitAll()
								.antMatchers("/boat/availability").permitAll()
								.antMatchers("/boat/pagination**").permitAll()
								.antMatchers("/fishingCourse/availability**").permitAll()
