...
insert into app_user (username, password, first_name, last_name, email, enabled, verification_code, phone_number, last_password_reset_date) values ('daco', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Danilo', 'Korac', 'asd@example.com', true, '1', '06465435643', '2021-12-08 23:06:00.000-00');
insert into app_user_roles (user_id, role_id) values (1, 3);
...
insert into app_user_roles (user_id, role_id) values (2, 4);
...
insert into cottage_reservation (start_date, end_date, guest_capacity, price, cottage_id,customer_id) values ('2022-05-18', '2022-05-25', 5, 70, 1,1);
